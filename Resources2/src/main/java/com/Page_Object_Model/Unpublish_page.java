...
public class Unpublish_page {
	...
	@FindBy(xpath = "//label[@class='btn btn-violet file_upload_btn onkeyup']")
	...
	@FindBy(xpath = "(//button[@title='Insert/edit media'])[1]")
	private WebElement insert;
	
	@FindBy(xpath = "(//input[@id='form-field_5053293532291665746103651'])[1]")
	private WebElement source;
	
	@FindBy(xpath = "//button[normalize-space()='Save']")
	private WebElement save;
	
	@FindBy(xpath = "//label[normalize-space()='Add tags']")
	private WebElement javalink;

	public Unpublish_page(WebDriver Clog) {
		this.driver = Clog;
